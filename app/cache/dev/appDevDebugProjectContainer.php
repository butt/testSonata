...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'acme.demo.admin.author' => 'getAcme_Demo_Admin_AuthorService',
            'acme.demo.admin.post' => 'getAcme_Demo_Admin_PostService',
    ...
    /**
     * Gets the 'acme.demo.admin.author' service.
     *
     * @return Acme\DemoBundle\Admin\AuthorAdmin A Acme\DemoBundle\Admin\AuthorAdmin instance.
     */
    protected function getAcme_Demo_Admin_AuthorService()
    {
        $instance = new \Acme\DemoBundle\Admin\AuthorAdmin('acme.demo.admin.author', 'Acme\\DemoBundle\\Entity\\Author', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'acme.demo.admin.post' service.
     *
     * @return Acme\DemoBundle\Admin\PostAdmin A Acme\DemoBundle\Admin\PostAdmin instance.
     */
    protected function getAcme_Demo_Admin_PostService()
    {
        $instance = new \Acme\DemoBundle\Admin\PostAdmin('acme.demo.admin.post', 'Acme\\DemoBundle\\Entity\\Post', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'Z:/Vido/vido/sonata/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('Z:/Vido/vido/sonata/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'Z:/Vido/vido/sonata/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'Z:/Vido/vido/sonata/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_c87202a0fbd9bed06395795619783cae');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_c87202a0fbd9bed06395795619783cae');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_c87202a0fbd9bed06395795619783cae');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'Z:\\Vido\\vido\\sonata\\src\\Acme\\DemoBundle\\Entity')), 'Acme\\DemoBundle\\Entity');
        ...
        $e->setProxyDir('Z:/Vido/vido/sonata/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'Z:/Vido/vido/sonata/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'd63d9fe3318911af070650fa398be040788d00f1');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('Z:/Vido/vido/sonata/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:Z:/Vido/vido/sonata/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'Z:/Vido/vido/sonata/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'Z:/Vido/vido/sonata/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('Z:/Vido/vido/sonata/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('Z:/Vido/vido/sonata/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('Z:/Vido/vido/sonata/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('Z:/Vido/vido/sonata/app/cache/dev/sessions');
    }
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'Acme Demo Bundle', 'bundles/sonataadmin/logo_title.png', array('html5_validate' => true, 'confirm_exit' => true, 'use_select2' => true));
        ...
        $instance->setAdminServiceIds(array(0 => 'acme.demo.admin.author', 1 => 'acme.demo.admin.post'));
        $instance->setAdminGroups(array('Authors Group' => array('label' => 'Authors Group', 'label_catalogue' => 'SonataAdminBundle', 'roles' => array(), 'items' => array(0 => 'acme.demo.admin.author', 1 => 'acme.demo.admin.post'))));
        $instance->setAdminClasses(array('Acme\\DemoBundle\\Entity\\Author' => 'acme.demo.admin.author', 'Acme\\DemoBundle\\Entity\\Post' => 'acme.demo.admin.post'));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'acme.demo.admin.author', 1 => 'acme.demo.admin.post'), $this);
    }
    ...
    {
        return $this->services['sonata.block.context_manager.default'] = new \Sonata\BlockBundle\Block\BlockContextManager($this->get('sonata.block.loader.chain'), $this->get('sonata.block.manager'), array());
    }
    ...
    {
        return $this->services['sonata.block.form.type.block'] = new \Sonata\BlockBundle\Form\Type\ServiceListType($this->get('sonata.block.manager'), array());
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'Z:/Vido/vido/sonata/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'Z:/Vido/vido/sonata/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'Z:/Vido/vido/sonata/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'Z:/Vido/vido/sonata/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\sonata-project\\block-bundle\\Sonata\\BlockBundle/Resources/views', 'SonataBlock');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\sonata-project\\doctrine-orm-admin-bundle\\Sonata\\DoctrineORMAdminBundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/views', 'SonataAdmin');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('Z:/Vido/vido/sonata/app/Resources/views');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('Z:\\Vido\\vido\\sonata\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d63d9fe3318911af070650fa398be040788d00f1');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'Z:/Vido/vido/sonata/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('Z:/Vido/vido/sonata/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['sonata.block.templating.helper'] = new \Sonata\BlockBundle\Templating\Helper\BlockHelper($this->get('sonata.block.manager'), array(), $this->get('sonata.block.renderer.default'), $this->get('sonata.block.context_manager.default'), NULL, $this->get('sonata.block.cache.handler.default', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'Z:/Vido/vido/sonata/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'Z:\\Vido\\vido\\sonata\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'Z:/Vido/vido/sonata/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'Z:/Vido/vido/sonata/app/cache/dev',
            'kernel.logs_dir' => 'Z:/Vido/vido/sonata/app/logs',
            ...
            'locale' => 'en',
            'secret' => 'd63d9fe3318911af070650fa398be040788d00f1',
            'database_path' => NULL,
            ...
            'debug.container.dump' => 'Z:/Vido/vido/sonata/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'd63d9fe3318911af070650fa398be040788d00f1',
            ...
            'session.save_path' => 'Z:/Vido/vido/sonata/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'Z:\\Vido\\vido\\sonata\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:Z:/Vido/vido/sonata/app/cache/dev/profiler',
            ...
            'router.resource' => 'Z:/Vido/vido/sonata/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'Z:/Vido/vido/sonata/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'Z:/Vido/vido/sonata/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'Z:/Vido/vido/sonata/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'Z:/Vido/vido/sonata/app/../web',
            'assetic.write_to' => 'Z:/Vido/vido/sonata/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'Z:/Vido/vido/sonata/app/cache/dev/doctrine/orm/Proxies',
